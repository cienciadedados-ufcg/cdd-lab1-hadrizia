...
```
  ...
  Os boxplots acima indicam que as três séries com maior número total de votos são curtas, ou seja, possuem mais de 100 episódios (a nível de curiosidade, veremos quais são a seguir). Percebemos também que, em geral, as séries que recebem mais votos são as mais longas.
...
```
  ...
  Nessa tabela fica clara a popoularidade de Game of Thrones, conquistando mais de 1 milhão e 300 mil votos ao todo. The Walking Dead está quase classificada como série longa, pois possui 99 episódios, e ocupa o segundo lugar com mais de 800 mil votos. Em terceiro está Breaking Bad, com 776 mil votos.
