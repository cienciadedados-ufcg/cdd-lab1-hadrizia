...
```
  ...
  Os gráficos acima exibem a relação entre o episódio e a avaliação dada pelo usuários por temporada em cada uma das três séries. Como a interpretação da variação é difícil no gráfico, optou-se por calcular o coeficiente de variação das avaliações (cv_avaliacao) para cada série:
